# -*- coding: utf-8 -*-
"""
Created on Mon Jun  1 08:09:42 2020
...
class BizimOyunumuz():
    def __init__(self):
        self.pencere_yuksekligi = 702
        self.pencere_genisligi = 1200
        self.Pencere = pygame.display.set_mode((self.pencere_genisligi,self.pencere_yuksekligi))
        pygame.display.set_caption("sinek Yakalama")
        self.Clock = pygame.time.Clock()

        self.ArkaPlan = pygame.image.load("background.png").convert_alpha()
        self.BizimKare = pygame.image.load("kurbaga.png").convert_alpha()
        self.YakalaKare = pygame.image.load("sinek.png").convert_alpha()

        self.Start = pygame.image.load("start.png").convert_alpha()
        self.Exit =  pygame.image.load("exit.png").convert_alpha()
        self.Retry = pygame.image.load("retry.png").convert_alpha()

        self.BizimKaremiz = DusenKareler(400,550, self.BizimKare,0)
    ...
    def Cizim(self):
        ...
        if self.Durum == "Start":
            self.Pencere.blit(self.GameOverFont.render("Kare Yakalama", True, (255, 0, 0)), (250, 200))
        ...
        if self.Durum == "Start":
            ...
            for DusKare in self.KareListesi:
                ...
                if (self.BizimKaremiz.Kordinatlar(100,100)).colliderect(DusKare.Kordinatlar(20,20)):
                    ...
                    pygame.mixer.Channel(0).play(pygame.mixer.Sound("ses.wav"))
                    print(self.Skor)
